...
def load_aspect_classification_model():
    model = MultiLabelClassificationModel(
        "bert", os.path.join("models", "aspect_classification_model"), use_cuda=CUDA
    )
    return model
...
def load_polarity_classification_model():
    model = ClassificationModel(
        "bert", os.path.join("models", "polarity_detection_model"), use_cuda=CUDA
    )
    return model
...
def load_aspect_extraction_model():
    model = NERModel("bert", os.path.join("models", "aspect_extraction_model"), labels=tags, use_cuda=CUDA)
    return model
